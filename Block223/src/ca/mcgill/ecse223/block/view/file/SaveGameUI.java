...
public class SaveGameUI extends JFrame {
  
  
	// Constants
	  private static final String WINDOW_TITLE = "Save Game";
	   ...
	   */
	  public SaveGameUI (Block223UI parent) {
	    this.parent = parent;
	    this._errorMsg = "";
	  ...
	  private void initComponents() {
	    ...
	    // init other elements
	    titleLabel = new JLabel("Are you sure you want to save the application?");
