...
public class PublishGameUI extends JFrame {

 
  // Constants
  private static final String WINDOW_TITLE = "Publish game";
   ...
   */
  public PublishGameUI (Block223UI parent) {
    this.parent = parent;
    this._errorMsg = "";
  ...
  private void initComponents() {
    ...
    // init other elements
    titleLabel = new JLabel("Are you sure you want to publish the game?");
    subTitleLabel = new JLabel("Please note you must be logged in as the Admin of the game to publish it."
                               + "\n Please note a game cannot be changed once it has been published.");
