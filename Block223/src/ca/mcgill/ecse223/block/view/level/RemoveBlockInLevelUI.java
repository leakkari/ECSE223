 ...
 * @author Jeremy Chow
 */
public class RemoveBlockInLevelUI extends JFrame {
  ...
  // Constants
  private static final String WINDOW_TITLE = "Block223 - Remove Block In Level";
   ...
   * @param parent
   */
  public RemoveBlockInLevelUI (Block223UI parent) {
    this.parent = parent;
    this._errorMsg  = "";
  ...
  private void initComponents() {
    ...
    // init other elements
    titleLabel = new JLabel("Select a game to remove a block: ");
    // init buttons
    ...
    oldHorizontalGridPositionLabel = new JLabel("X Position: ");
    oldHorizontalGridPositionTextField = new JFormattedTextField(formatter);
    oldVerticalGridPositionLabel = new JLabel("Y Position: ");
  ...
  private void confirmButtonPressed() {
    ...
    if (levelNumberTextField.getText().isEmpty()
      ...
      // handle empty
      _errorMsg = "Cannot remove block with empty text fields. Try again";
      refresh();
      return;
    }
    
    // try to get values from JLabels, throws exception if any are not numbers.
    int levelNumber, oldHorizontalGridPosition, oldVerticalGridPosition;
    try {
