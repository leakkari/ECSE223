...
public class Block223 implements Serializable
{
  ...
  // line 12 "../../../../../Block223 v2.ump"
   public Game findGame(String name){
     //System.out.println(games.get(0).equals(name));
  ...
  // line 22 "../../../../../Block223 v2.ump"
   public PlayedGame findPlayableGame(int id){
     for(PlayedGame curPlayedGame : playedGames) {
       ...
       //System.out.println("name of curplaygame: '" + curPlayedGame.getGame().getName() +"'");
       //System.out.println(curPlayedGame + "\nINitial wait time right after consturctor: " + curPlayedGame.getWaitTime());
   ...
   /**
    * TODO: add this umple file so it doesnt get overwritten
    */
   public void reinitialize () {
     // reinitialize all static memebrs of Block223 when object is deserialized
     
     /*
      * right now, i have bypassed using this method by just not using the hash maps cause
      * they get wiped every reload, but we really should we reinitialize them here.... if anyone 
      * wants to do that....
      * christos
      * 
      * o wow i did it im great yay
      */
     // reinit hash maps
     Game.reiniGameHash(this.getGames());
     //PlayedGame.reiniPlayedGameHash(this.getPlayedGames());
     User.reiniUserHash(this.getUsers());
