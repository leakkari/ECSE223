...
public class User implements Serializable
{
  ...
  /**
   * added be lea, updated by Trevor 
   * it works but it's really sketch
   */
  // line 44 "../../../../../Block223 v2.ump" 
   public static String findUsername(UserRole userrole) {
    String returnstring = null;
    Collection<User> users = usersByUsername.values();
    for (User u : users) {
...
// added for persistence tests by christos 
  public static void reiniUserHash (List<User> users) {
