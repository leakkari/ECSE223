...
public class BlockAssignment implements Serializable
{
  ...
  {
	  maxNumberOfHorizontalBlocks = ((Game.PLAY_AREA_SIDE + Game.COLUMNS_PADDING) - (Game.WALL_PADDING*2))/(Block.SIZE + Game.COLUMNS_PADDING);
	  maxNumberOfVerticalBlocks = (Game.PLAY_AREA_SIDE + Game.ROW_PADDING - Paddle.VERTICAL_DISTANCE - Paddle.PADDLE_WIDTH - Game.WALL_PADDING)/(Block.SIZE + Game.ROW_PADDING);
